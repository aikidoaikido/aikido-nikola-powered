...
BLOG_AUTHOR = "Carlos Mat\u00edas de la Torre"  # (translatable)
BLOG_TITLE = "Asociaci\u00f3n Cordobesa de Aikido"  # (translatable)
# This is the main URL for your site. It will be used
# in a prominent link
#SITE_URL = "http://www.aikidoaikido.com.ar/"
SITE_URL = "http://127.0.0.1:8000/"
# This is the URL where Nikola's output will be deployed.
# If not set, defaults to SITE_URL
# BASE_URL = "http://www.aikidoaikido.com.ar"
BLOG_EMAIL = "webmaster@aikidoaikido.com.ar"
BLOG_DESCRIPTION = "Sitio de la Asociaci\u00f3n Cordobesa de Aikido. Informaci\u00f3n institucional, general, para practicantes, eventos, etc."  # (translatable)
...
NAVIGATION_LINKS = {
    DEFAULT_LANG: (
        ...
        ("/galleries/demo/index.html", "Galería"),
        ("/dojos.html", "Dojos"),
        ("/danes.html", "Danes"),
        ("/aikido-para-ninos.html", "Niños"),
...
POSTS = []
PAGES = (
    ("content/index.rst", "", "home_page.tmpl"),
    ("content/*.rst", "", "story.tmpl"),
    ("content/*.txt", "", "story.tmpl"),
    ("content/*.md", "", "story.tmpl"),
)
...
# (translatable)
CONTENT_FOOTER = 'Contents &copy; {date} <a href="/contacto.html">Asociación Cordobesa de Aikido</a>  - Powered by <a href="http://getnikola.com" rel="nofollow">Nikola</a> {license}'
...
# is in the manual.
COMMENT_SYSTEM_ID = "332527823622847"
